...
def w8a8_block_fp8_matmul_triton(
    ...
    if hopper_tuned:
        ...
        # ponytail: on SM80 fp8 tl.dot/load is unavailable in triton; dense
        # fp8-block linears are served by the marlin path instead
        # (Fp8LinearMethod auto-enables it for sm < 89).
